...
#pragma config(Motor,  port7,           liftMotorLeft, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           rightMotorFront, tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           rightMotorBack, tmotorVex393HighSpeed_MC29, openLoop, reversed)
